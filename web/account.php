				 ...
				 <div class="register-top-grid">
					<h3>personal information</h3>
					 ...
					 <div>
						...
						<input type="email" style="width:96%; height:38px;"> 
					 </div>
					 <div>
						 ...
						 <select id="security-question" name="securityquestion" style="width: 96%; height:38px;" >
					 ...
					 <div>Mobile number<label>*</label></span>
						 <input type="text"> 
					 </div>

					 <div>Answer<label>*</label></span>
						 <input type="text"> 
					 </div>
